...
public class PlayerSpawner : MonoBehaviour
{
    ...
    {
        PhotonNetwork.Instantiate("Draft Knight", new Vector2(-3f, 1.56f), knightPrefab.transform.rotation);
    ...
    {
        PhotonNetwork.Instantiate("Draft Dragon", new Vector2(-5f, 4f), dragonPrefab.transform.rotation);
